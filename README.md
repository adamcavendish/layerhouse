<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="docs/assets/brand/layerhouse-lockup-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="docs/assets/brand/layerhouse-lockup-light.svg">
    <img alt="Layerhouse" src="docs/assets/brand/layerhouse-lockup-light.svg" width="420">
  </picture>
</p>
...
Full documentation at [adamcavendish.github.io/layerhouse](https://adamcavendish.github.io/layerhouse/).

- [Configuration Reference](https://adamcavendish.github.io/layerhouse/reference/config-reference.html)
- [Authentication Setup](https://adamcavendish.github.io/layerhouse/authentication.html)
- [Clustering Guide](https://adamcavendish.github.io/layerhouse/clustering.html)
...
`layerhouse-ctl air-gapped ...` or enable cert-manager before installing.
...
Pods must be named `<prefix>-<N>` (for example `layerhouse-0`). Node identity is
derived from the hostname suffix. All pods share identical configuration and
discover peers through the headless service.

For internal or air-gapped clusters, use `layerhouse-ctl air-gapped ...` to
